...
//        image = Image.getInstance("/src/main/resources/static/web/assets/img/logo.png");
//        image.scaleAbsolute(100,100);
//        image.setAbsolutePosition(100, 100);

        PdfPTable table = new PdfPTable(4);
        Stream.of("Brand","Product","Type","Price").forEach(table::addCell);
        ...
        ticket_accessories.forEach(ticket_accessory -> {
            ...
            table.addCell("$ " + ticket_accessory.getAccessory().getPrice().toString());
        });
        ...
        ticket_phones.forEach(ticket_phone -> {
            ...
            table.addCell("Phone");
            table.addCell("$ " + ticket_phone.getPhone().getPrice().toString());
        });
        ...
        ticket_consoles.forEach(ticket_console -> {
            ...
            table.addCell("Accessory");
            table.addCell("$ " + ticket_console.getConsole().getPrice());
        });
